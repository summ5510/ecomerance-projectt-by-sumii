...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <ul class="navbar-nav me-auto">
                ...
                if(!isset($_SESSION['username'])) {
                    ...
                    echo "<li class='nav-item'>
                    <a class='second-nav nav-link text-white' href='./User/profile.php'>Welcome ". $_SESSION['username']."</a>
                </li>";
                }
        ...
        <!-- Third Child -->
        <div class="bg-light home-heading bg-image">
                <div class="content text-white text-center">
                <h1 class="text-center heading-text">Modern Couture</h1>
                <p class="text-center">Communications is at the heart of e-commerce and community</p>
                <a href="index.php" class="explore-btn">Explore more</a>
                </div>
        </div>
